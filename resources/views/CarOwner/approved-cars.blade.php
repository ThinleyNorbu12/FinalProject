...
<div class="d-flex justify-content-between align-items-center">
    ...
    <span class="badge bg-success fs-6">{{ $approvedCars->count() }} Car(s)</span>
</div>
@endsection
                                    ...
                                    <div class="row g-3">
                                        <div class="col-6">
                                            <div class="info-item">
                                                ...
                                                <strong>Type:</strong>
                                                <span class="d-block text-muted">{{ $car->vehicle_type }}</span>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="info-item">
                                        ...
                                        <div class="col-6">
                                            <div class="info-item">
                                                ...
                                                <span class="d-block text-muted">{{ $car->registration_no }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="d-none d-lg-block">
                <div class="card border-0 shadow-sm">
                                ...
                                <tbody>
                                    @foreach($approvedCars as $car)
                                        <tr class="searchable-row">
                                            ...
                                            <td class="py-3">
                                                <div class="fw-medium">{{ $car->maker }}</div>
                                            </td>
                                            <td class="py-3">
                                                <div class="fw-medium">{{ $car->model }}</div>
                                            </td>
                                            <td class="py-3">
                                            ...
                                            <td class="py-3">
                                                <span class="badge bg-{{ $car->car_condition === 'Excellent' ? 'success' : ($car->car_condition === 'Good' ? 'info' : 'warning') }} bg-opacity-10 text-{{ $car->car_condition === 'Excellent' ? 'success' : ($car->car_condition === 'Good' ? 'info' : 'warning') }}">
                                                    {{ $car->car_condition }}
                                                </span>
                                            </td>
                                            {{-- <td class="py-3">
                    ...
                    <div class="card-footer bg-light border-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                Showing {{ $approvedCars->count() }} approved cars
                            </small>
...
<script>
    ...
    document.getElementById('searchInput')?.addEventListener('keyup', function() {
        ...
        if (showingText) {
            showingText.textContent = `Showing ${visibleRows} of {{ $approvedCars->count() }} approved cars`;
        }
    });
