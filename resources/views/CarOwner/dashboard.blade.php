    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="page-actions">
            <button class="btn btn-primary">
                <a href="{{ route('carowner.rentCar') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-lg-4 col-md-6">
                        <a href="{{ route('carowner.rentCar') }}" class="text-decoration-none">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="{{ route('carowner.car-inspection') }}" class="text-decoration-none position-relative">
                            <div class="action-card border rounded-3 p-4 h-100 text-center hover-shadow transition-all">
