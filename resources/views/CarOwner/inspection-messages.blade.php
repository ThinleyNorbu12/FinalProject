...
<div class="d-flex justify-content-between align-items-center">
    ...
    <span class="badge bg-primary fs-6">{{ $inspectionRequests->count() }} Request(s)</span>
</div>
@endsection
    ...
    <div class="col-12">
                        ...
                        <div class="card h-100 shadow-sm border-0">
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <h5 class="card-title mb-1 text-primary">
                                            ...
                                            {{ $request->car->maker ?? 'N/A' }} {{ $request->car->model ?? '' }}
                                        </h5>
                                    ...
                                    <span class="badge bg-{{ $request->status === 'canceled' ? 'danger' : ($request->request_accepted ? 'success' : 'warning') }} fs-6">
                            ...
                            <div class="card-body">
                                <div class="inspection-details mb-3">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <p class="mb-0 fw-medium">{{ $request->inspection_time }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="mb-0">{{ $request->location }}</p>
                                </div>
                            ...
                            <div class="card-footer bg-white border-0 pt-0">
                                <div class="d-grid gap-2">
                                    ...
                                    @if($request->status !== 'canceled' && !$request->request_accepted && !$request->date_time_updated)
                                        <form action="{{ route('inspection.accept', $request->id) }}" method="POST" class="accept-form">
                                            @csrf
                                    ...
                                    <div class="row g-2">
                                        ...
                                        @if($request->status !== 'canceled' && !$request->request_accepted && !$request->date_time_updated)
                                            ...
                                            @else
                                                <div class="col-6">
                                                    <form action="{{ route('inspection.editdatetime', $request->id) }}" method="GET" class="edit-form">
                                                        @csrf
                                        ...
                                        @if($request->status !== 'canceled' && !$request->request_accepted && !$request->date_time_updated)
                                            <div class="col-6">
                                                <form action="{{ route('inspection.cancel', $request->id) }}" method="POST" class="cancel-form">
                                                    @csrf
        ...
        @else
            <div class="text-center py-5">
                ...
                <a href="{{ route('carowner.dashboard') }}" class="btn btn-primary">
