                ...
                <tbody>
                    @foreach($inspectionRequests as $request)
                        <tr>
                            ...
                            <td>
                                <button type="button" 
                                        onclick="viewInspectionDetails({{ $request->car->id }}, '{{ $request->car->registration_no ?? '' }}', '{{ $request->car->owner->license_number ?? '' }}')" 
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="inspectionForm" action="{{ route('car-admin.inspection-approval') }}" method="POST">
                    @csrf
