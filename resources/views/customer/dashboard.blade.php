    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-menu">
                <a href="{{ route('customer.dashboard') }}" class="sidebar-menu-item active ">
                                ...
                                @foreach($rentalHistory as $rental)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge" style="background-color: #6b7280; color: white; padding: 5px 10px; border-radius: 12px;">{{ ucfirst($rental->status) }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="cars-grid">
                        ...
                        <div class="car-card">
                            ...
                            <div class="car-image">
                                ...
                                @else
                                   <img src="{{ asset('carimage/defaultcar.jpg') }}" alt="Car Image">
                                @endif
                            </div>
