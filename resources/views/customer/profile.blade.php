            ...
            <div class="profile-container">
                ...
                <div class="profile-header">
                    <div class="avatar-container">
                        <img src="{{ Auth::guard('customer')->check() && Auth::guard('customer')->user()->profile_image 
                ...
                <div class="tab-content active" id="personal-info">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-icon">
                                            ...
                                            <input type="text" class="form-control" id="cid" name="cid" 
                                                value="{{ Auth::guard('customer')->user()->cid_no ?? '' }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-icon">
                                            ...
                                            <input type="text" class="form-control" id="dateOfBirth" name="dob" 
                                                value="{{ $formattedDob }}" placeholder="DD/MM/YYYY">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="profile-section">
                        ...
                        <form id="avatarForm" action="{{ route('customer.profile.update-avatar') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="profile-section">
                        ...
                        <div class="license-info mt-4">
                            @if(Auth::guard('customer')->user()->license_front)
                                <img src="{{ asset('storage/licenses/' . Auth::guard('customer')->user()->license_front) }}" 
                                    alt="Front License" class="license-image">
                            @endif
                            @if(Auth::guard('customer')->user()->license_back)
                                <img src="{{ asset('storage/licenses/' . Auth::guard('customer')->user()->license_back) }}" 
