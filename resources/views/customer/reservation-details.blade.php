        ...
        <div class="reservation-details-card">
            ...
            <div class="car-details-section">
                <div class="car-image-container">
                    <img src="{{ $booking->car->image_path ?? '/api/placeholder/300/200' }}" alt="{{ $booking->car->make }} {{ $booking->car->model }}">
                </div>
                <div class="car-info">
                    ...
                    <div>
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                @php
                                    $days = \Carbon\Carbon::parse($booking->pickup_datetime)->diffInDays(\Carbon\Carbon::parse($booking->dropoff_datetime));
                                    $hours = \Carbon\Carbon::parse($booking->pickup_datetime)->copy()->addDays($days)->diffInHours(\Carbon\Carbon::parse($booking->dropoff_datetime));
                                @endphp
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="detail-item">
                            ...
                            <div class="detail-value">{{ Auth::guard('customer')->user()->name }}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Email Address</div>
                            <div class="detail-value">{{ Auth::guard('customer')->user()->email }}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Phone Number</div>
                            <div class="detail-value">{{ Auth::guard('customer')->user()->phone }}</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="detail-item">
                            <div class="detail-label">License Number</div>
                            <div class="detail-value">{{ Auth::guard('customer')->user()->license_number ?? 'Not provided' }}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">License Expiry</div>
                            <div class="detail-value">
                                {{ Auth::guard('customer')->user()->license_expiry 
                                    ? \Carbon\Carbon::parse(Auth::guard('customer')->user()->license_expiry)->format('M d, Y')
                                    : 'Not provided' }}
                            </div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">License Verified</div>
                            <div class="detail-value">{{ Auth::guard('customer')->user()->is_license_verified ? 'Yes' : 'No' }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <strong>Car Picked Up</strong>
                            <p>Vehicle was successfully picked up from {{ $booking-><div class="timeline-content">
                            <strong>Car Picked Up</strong>
                            <p>Vehicle was successfully picked up from {{ $booking->pickup_location }}.</p>
                        </div>
                    </div>
