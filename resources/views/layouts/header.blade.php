    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            ...
            @if(Auth::check())
                ...
                @elseif(Auth::user()->role === 'car_owner')
                    <a class="navbar-brand ms-2" href="{{ route('carowner.dashboard') }}">
                        <img src="{{ asset('assets/images/logo.png') }}" alt="Logo" height="30">
            ...
            <div class="ms-auto d-flex align-items-center">
                ...
                <div class="dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        @if(Auth::check())
                            <img src="{{ asset('assets/images/' . (Auth::user()->profile_image ?? 'thinley.jpg')) }}" class="rounded-circle me-2" alt="Profile" width="32" height="32">
                            <span>{{ Auth::user()->name ?? 'User' }}</span>
                        @else
                            <img src="{{ asset('assets/images/thinley.jpg') }}" class="rounded-circle me-2" alt="Profile" width="32" height="32">
                            <span>Guest</span>
                        @endif
                    </a>
