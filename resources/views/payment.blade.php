        ...
        <div class="payment-container">
            ...
            <div class="payment-body">
                ...
                <div class="payment-summary">
                    ...
                    <div class="vehicle-info">
                        ...
                        <div class="vehicle-details">
                            ...
                            <div class="vehicle-specs">
                                ...
                                <span><i class="fas fa-door-open"></i> {{ $booking->car->number_of_doors }} doors</span>
                            </div>
                    ...
                    <div class="summary-item">
                        <span>Vehicle</span>
                        <span>{{ $booking->car->maker }} {{ $booking->car->model }} ({{ $booking->car->registration_no }})</span>
                    </div>

                    @if($booking->car->mileage_limit)
                    <div class="summary-item">
                        <span>Daily Mileage Limit</span>
                        <span>{{ number_format($booking->car->mileage_limit) }} km/day</span>
                    </div>
                    @endif
                    ...
                    <!-- Pricing Breakdown -->
                    <div class="summary-item">
                        <span>Rental Fee ({{ $days }} day{{ $days > 1 ? 's' : '' }} × BTN {{ number_format($dailyRate, 2) }})</span>
                        <span>BTN {{ number_format($dailyRate * $days, 2) }}</span>
                    </div>

                    <div class="summary-item">
                        <span>Insurance Fee</span>
                        <span>BTN {{ number_format($insuranceFee, 2) }}</span>
                    </div>

                    <div class="summary-item">
                        <span>Service Fee</span>
                        <span>BTN {{ number_format($serviceFee, 2) }}</span>
                    </div>
                    ...
                    <div class="summary-item text-muted">
                        ...
                        <span><small>BTN {{ number_format($booking->car->price_per_km, 2) }}/km</small></span>
                    </div>
                    @endif
                    ...
                    <div class="summary-item mb-0">
                        ...
                        <span class="total-amount">BTN {{ number_format($totalPrice, 2) }}</span>
                    </div>
                    ...
                    <div class="payment-option" id="option1">
                        ...
                        <div class="payment-option-body">
                            ...
                            <form id="qrPaymentForm" action="{{ route('booking.payment.qr', ['bookingId' => $booking->id]) }}" method="POST" enctype="multipart/form-data" style="display: none;">
                                @csrf
                            ...
                            <div class="bank-instructions hidden" id="bob-instructions">
                                ...
                                <ol>
                                    ...
                                    <li>Enter amount: BTN {{ number_format($totalPrice, 2) }}</li>
                            ...
                            <div class="qr-code-container hidden" id="qrContainer">
                                ...
                                <div class="qr-details text-center">
                                    ...
                                    <p class="amount">Amount: <strong>BTN {{ number_format($totalPrice, 2) }}</strong></p>
                                    <p class="booking-ref">Booking: <strong>#{{ $booking->id }}</strong></p>
                                </div>
                    ...
                    <div class="payment-option" id="option2">
                        ...
                        <div class="payment-option-body">
                            {{-- <form id="bankTransferForm" action="{{ route('booking.payment.bankTransfer', ['bookingId' => $booking->id]) }}" method="POST"> --}}
                                @csrf
                                <input type="hidden" name="total_amount" value="{{ $totalPrice }}">
                    ...
                    <div class="payment-option" id="option3">
                        ...
                        <div class="payment-option-body">
                            ...
                            <div class="alert alert-warning">
                                ...
                                Please note that choosing "Pay at Pickup" option means you will need to pay the full amount of <strong>BTN {{ number_format($totalPrice, 2) }}</strong> when you meet for the car handover.
                            </div>
                            
                            @if($booking->car->mileage_limit)
                            <div class="alert alert-info">
                                <i class="fas fa-road me-2"></i>
                                <strong>Mileage Limit:</strong> {{ number_format($booking->car->mileage_limit) }} km per day. 
                                @if($booking->car->price_per_km)
                                    Excess mileage will be charged at BTN {{ number_format($booking->car->price_per_km, 2) }} per km.
                                @endif
                            </div>
                            @endif
                            
                            <!-- Hidden form for Pay Later submission -->
                            <form id="payLaterForm" method="POST" action="{{ route('booking.payment.payLater', ['bookingId' => $booking->id]) }}" style="display: none;">
                                @csrf
                                <input type="hidden" name="total_amount" value="{{ $totalPrice }}">
                                <input type="hidden" name="notes" value="Customer opted to pay at pickup - Total: BTN {{ number_format($totalPrice, 2) }}">
                            </form>
                ...
                <div class="footer-actions mt-4 d-flex justify-content-between">
                    <a href="{{ route('booking.summary', ['bookingId' => $booking->id]) }}" class="btn btn-secondary cancel-btn">Cancel</a>
