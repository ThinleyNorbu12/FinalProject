                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                <p class="mb-1"><strong>Car:</strong> {{ $booking->car->maker }} {{ $booking->car->model }}</p>
                                <p class="mb-1"><strong>Duration:</strong> {{ \Carbon\Carbon::parse($booking->pickup_date)->diffInDays(\Carbon\Carbon::parse($booking->dropoff_date)) + 1 }} days</p>
                                <p class="mb-1"><strong>Pick-up:</strong> {{ \Carbon\Carbon::parse($booking->pickup_date)->format('M d, Y') }}</p>
                            </div>
                            @php
                            ...
                            @endphp
                            <div class="text-end">
                                <h5>Total: Nu. {{ number_format($totalPrice, 2) }}</h5>
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="drukpay-container mb-4">
                        <div class="text-center mb-4">
                            <img src="{{ asset('images/drukpay-logo.png') }}" alt="DrukPay Logo" class="img-fluid" style="max-height: 60px;" onerror="this.src='/api/placeholder/240/60'; this.alt='DrukPay'">
                            <h5 class="mt-3">Select Your Bank</h5>
                            <p class="text-muted">Choose your bank to proceed with payment</p>
                        </div>

                        <form action="{{ route('payment.process', ['bookingId' => $booking->id]) }}" method="POST">
                            @csrf
                                    ...
                                    <div class="bank-selection">
                                        ...
                                        <div class="bank-option mb-3">
                                            ...
                                            <label class="btn btn-outline-primary w-100 d-flex align-items-center p-3" for="bob">
                                                <img src="{{ asset('images/bob-logo.png') }}" alt="BOB Logo" class="bank-logo me-3" onerror="this.src='/api/placeholder/40/40'; this.alt='BOB'">
                                        ...
                                        <div class="bank-option mb-3">
                                            ...
                                            <label class="btn btn-outline-primary w-100 d-flex align-items-center p-3" for="bnbl">
                                                <img src="{{ asset('images/bnbl-logo.png') }}" alt="BNBL Logo" class="bank-logo me-3" onerror="this.src='/api/placeholder/40/40'; this.alt='BNBL'">
                                                <div class="text-start">
                                        ...
                                        <div class="bank-option mb-3">
                                            ...
                                            <label class="btn btn-outline-primary w-100 d-flex align-items-center p-3" for="tbank">
                                                <img src="{{ asset('images/tbank-logo.png') }}" alt="T-Bank Logo" class="bank-logo me-3" onerror="this.src='/api/placeholder/40/40'; this.alt='TBank'">
                                                <div class="text-start">
                                        ...
                                        <div class="bank-option mb-3">
                                            ...
                                            <label class="btn btn-outline-primary w-100 d-flex align-items-center p-3" for="bdbl">
                                                <img src="{{ asset('images/bdbl-logo.png') }}" alt="BDBL Logo" class="bank-logo me-3" onerror="this.src='/api/placeholder/40/40'; this.alt='BDBL'">
                                                <div class="text-start">
                                        ...
                                        <div class="bank-option mb-3">
                                            ...
                                            <label class="btn btn-outline-primary w-100 d-flex align-items-center p-3" for="drukpnb">
                                                <img src="{{ asset('images/drukpnb-logo.png') }}" alt="Druk PNB Logo" class="bank-logo me-3" onerror="this.src='/api/placeholder/40/40'; this.alt='DrukPNB'">
                                                <div class="text-start">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-1"><strong>Transaction ID:</strong> TR-{{ $booking->id }}-{{ time() }}</p>
                                        </div>
                                        <div class="col-md-6 text-md-end">
                                            <p class="mb-1"><strong>Amount:</strong> Nu. {{ number_format($totalPrice, 2) }}</p>
                                    ...
                                    <div class="alert alert-info">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0">The amount of Nu. {{ number_format($totalPrice, 2) }} will be debited from your account.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="{{ route('booking.summary', ['bookingId' => $booking->id]) }}" class="btn btn-outline-secondary">
                                    <i class="fas fa-arrow-left me-2"></i>Back to Summary
                                </a>
                                <button type="submit" class="btn btn-success" id="payButton">
                                    <i class="fas fa-lock me-2"></i>Proceed to Pay - Nu. {{ number_format($totalPrice, 2) }}
                                </button>
                            </div>
                        </form>
                    </div>
