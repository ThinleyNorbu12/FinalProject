            ...
            <?php if($allCars->count()): ?>
                <?php $__currentLoopData = $allCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="car">
                        ...
                        <p>BTN <?php echo e(number_format($car->rate_per_day, 2)); ?>/day</p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fetchCarDetails(carId, carSource) {
            ...
            const url = `<?php echo e(url('/cars')); ?>/${carId}/details`;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\GitHub\FinalProject\resources\views/home.blade.php ENDPATH**/ ?>