...
<div class="search-results-container">
    ...
    <div class="search-info">
        ...
        <?php if(request()->has('pickup_location') || request()->has('pickup_date')): ?>
            <div class="search-params">
                <?php if(request('pickup_location')): ?>
                    <div class="search-param">
                        <strong><i class="fas fa-map-marker-alt"></i> Pickup Location</strong>
                        <span><?php echo e(request('pickup_location')); ?></span>
                    </div>
                <?php endif; ?>
                <?php if(request('pickup_date')): ?>
                    <div class="search-param">
                        <strong><i class="fas fa-calendar-alt"></i> Pickup Date</strong>
                        <span><?php echo e(\Carbon\Carbon::parse(request('pickup_date'))->format('M d, Y')); ?></span>
                    </div>
                <?php endif; ?>
                <?php if(request('pickup_time')): ?>
                    <div class="search-param">
                        <strong><i class="fas fa-clock"></i> Pickup Time</strong>
                        <span><?php echo e(\Carbon\Carbon::createFromTime(...explode(':', request('pickup_time')))->format('h:i A')); ?></span>
                    </div>
                <?php endif; ?>
                <?php if(request('dropoff_date')): ?>
                    <div class="search-param">
                        <strong><i class="fas fa-calendar-check"></i> Return Date</strong>
                        <span><?php echo e(\Carbon\Carbon::parse(request('dropoff_date'))->format('M d, Y')); ?></span>
                    </div>
                <?php endif; ?>
                <?php if(request('dropoff_time')): ?>
                    <div class="search-param">
                        <strong><i class="fas fa-clock"></i> Return Time</strong>
                        <span><?php echo e(\Carbon\Carbon::createFromTime(...explode(':', request('dropoff_time')))->format('h:i A')); ?></span>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <?php if($totalCars > 0): ?>
        ...
        <div style="background: white; padding: 20px; border-radius: 12px; margin-bottom: 30px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
            <h3 style="margin: 0; color: #2d3748;">
                <i class="fas fa-car"></i> Found <?php echo e($totalCars); ?> Available <?php echo e(Str::plural('Car', $totalCars)); ?>

            </h3>
            <p style="margin: 8px 0 0; color: #718096;">
                <?php echo e($approvedCars->count()); ?> approved cars, 
                <?php echo e($completedBookingCars->count()); ?> cars with completed bookings,
                <?php echo e($adminCars->count()); ?> premium cars
            </p>
        </div>
        ...
        <?php if($approvedCars->count() > 0): ?>
            <div class="section-header">
                <h3 class="section-title">
                    ...
                    Approved Cars (<?php echo e($approvedCars->count()); ?>)
                </h3>
        ...
        <?php if($completedBookingCars->count() > 0): ?>
            <div class="section-header">
                <h3 class="section-title">
                    <i class="fas fa-star" style="color: #4299e1;"></i> 
                    Proven Reliable Cars (<?php echo e($completedBookingCars->count()); ?>)
                </h3>
                <p class="section-subtitle">Cars with successful rental history</p>
            </div>
            
            <div class="cars-grid">
                <?php $__currentLoopData = $completedBookingCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($adminCars->count() > 0): ?>
            <div class="section-header">
                <h3 class="section-title">
                    <i class="fas fa-crown" style="color: #ed8936;"></i> 
                    Premium Fleet (<?php echo e($adminCars->count()); ?>)
                </h3>
                <p class="section-subtitle">Premium vehicles from our exclusive collection</p>
            </div>
            
            <div class="cars-grid">
                <?php $__currentLoopData = $adminCars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $car): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php else: ?>
        ...
        <div class="no-results">
            ...
            <a href="<?php echo e(url('/')); ?>" class="btn-search-again">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sangay Ngedup\Documents\GitHub\FinalProject\resources\views/search_results.blade.php ENDPATH**/ ?>