...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Car Owner Registration')); ?></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('carowner.register')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-footer text-center">
                    Already have an account? <a href="<?php echo e(route('carowner.login')); ?>">Login here</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sangay Ngedup\Documents\GitHub\FinalProject\resources\views/CarOwner/register.blade.php ENDPATH**/ ?>