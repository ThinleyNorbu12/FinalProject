...
<div class="dashboard-content">
    <div class="dashboard-header">
        ...
        <div class="header-actions">
            <form method="GET" action="<?php echo e(route('admin.reports.index')); ?>" class="date-filter-form">
    ...
    <div class="report-summary">
        <div class="summary-card">
            ...
            <div class="card-content">
                <h3><?php echo e($totalAdminCars); ?></h3>
                <p>Admin Cars</p>
            </div>
        </div>
        ...
        <div class="summary-card">
            ...
            <div class="card-content">
                <h3><?php echo e($totalOwnerCars); ?></h3>
                <p>Owner Cars</p>
            </div>
        </div>
        ...
        <div class="summary-card">
            ...
            <div class="card-content">
                <h3><?php echo e($totalInspections); ?></h3>
                <p>Inspections</p>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="revenue-stats">
                    <div class="stat-item">
                        ...
                        <span class="value">$<?php echo e(number_format($revenueData->total_revenue ?? 0, 2)); ?></span>
                    </div>
                    <div class="stat-item">
                    ...
                    <div class="stat-item">
                        ...
                        <span class="value">$<?php echo e(number_format($revenueData->average_booking_value ?? 0, 2)); ?></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="status-charts">
                    <div class="chart-section">
                        ...
                        <div class="status-list">
                            <?php $__currentLoopData = $adminCarStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="status-item">
                                <span class="status-label"><?php echo e(ucfirst($status->status)); ?>:</span>
                                <span class="status-count"><?php echo e($status->count); ?></span>
                            </div>
                    ...
                    <div class="chart-section">
                        <h4>Owner Cars</h4>
                        <div class="status-list">
                            <?php $__currentLoopData = $ownerCarStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="status-item">
                                <span class="status-label"><?php echo e(ucfirst($status->status)); ?>:</span>
                                <span class="status-count"><?php echo e($status->count); ?></span>
                            </div>
    ...
    <div class="report-row">
                    ...
                    <table class="report-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($car->booking_count); ?></td>
                            </tr>
        ...
        <div class="report-card">
            ...
            <div class="card-body">
                <div class="status-list">
                    <?php $__currentLoopData = $bookingStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="status-item">
                        <span class="status-label"><?php echo e(ucfirst($status->status)); ?>:</span>
                        <span class="status-count"><?php echo e($status->count); ?></span>
                        <div class="status-bar">
                            <div class="status-fill" style="width: <?php echo e(($status->count / $totalBookings) * 100); ?>%"></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="report-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $carTypeAnalysis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e(ucfirst($type->vehicle_type)); ?></td>
                                <td><?php echo e($type->count); ?></td>
                                <td>$<?php echo e(number_format($type->avg_price, 2)); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
                ...
                <div class="table-responsive">
                    <table class="report-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($booking->maker); ?> <?php echo e($booking->model); ?></td>
                                <td>
                    ...
                    <table class="report-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="status-badge status-<?php echo e($inspection->status); ?>">
                                        <?php echo e(ucfirst($inspection->status)); ?>

                                    </span>
                                </td>
                                <td><?php echo e(\Carbon\Carbon::parse($inspection->created_at)->format('M d, Y')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sangay Ngedup\Documents\GitHub\FinalProject\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>