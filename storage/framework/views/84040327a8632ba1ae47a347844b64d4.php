        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    <th>Total Amount:</th>
                                                    <td class="fw-bold">Nu. <?php echo e(number_format($booking->total_amount, 2)); ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                            ...
                            <div class="alert alert-warning">
                                ...
                                <ol class="mb-0">
                                    <li>Please include your Booking ID (#<?php echo e($booking->id); ?>) as reference when making the transfer.</li>
                    ...
                    <form action="<?php echo e(route('payment.process', $booking->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="transaction_id" name="transaction_id" required>
...
unset($__errorArgs, $__bag); ?>" id="payment_date" name="payment_date" required value="<?php echo e(date('Y-m-d')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="payment_proof" name="payment_proof" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('booking.summary', $booking->id)); ?>" class="btn btn-secondary">
