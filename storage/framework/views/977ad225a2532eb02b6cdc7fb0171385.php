...
<div id="sidebar" class="sidebar">
    <div id="sidebar-content" class="sidebar-content">
        <ul class="sidebar-links">
            <li><a href="<?php echo e(route('carowner.login')); ?>" id="carowner-link">CAROWNER DASHBOARD</a></li>
            <li><a href="<?php echo e(url('/car-admin')); ?>" id="admin-link">ADMIN DASHBOARD</a></li>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (carOwnerLink) {
            carOwnerLink.addEventListener('click', function (e) {
                const isCarOwnerLoggedIn = <?php echo e(Auth::guard('carowner')->check() ? 'true' : 'false'); ?>;
                if (!isCarOwnerLoggedIn) {
                    e.preventDefault();
                    showModal('Car Owner Access Required', 'You need to register or login as a car owner first.', '<?php echo e(route('carowner.register')); ?>', '<?php echo e(route('carowner.login')); ?>');
                }
            });
        }
        ...
        if (adminLink) {
            adminLink.addEventListener('click', function (e) {
                ...
                if (!isAdminLoggedIn) {
                    e.preventDefault();
                    showModal('Admin Access Required', 'You need to register or login as an admin first.', '<?php echo e(route('admin.register')); ?>', '<?php echo e(route('admin.login')); ?>');
                }
            });
        }
