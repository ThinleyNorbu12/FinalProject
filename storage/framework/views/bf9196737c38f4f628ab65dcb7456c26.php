            ...
            <div class="col-md-8">
                <div class="dashboard-links">
                    ...
                    <div class="links-container">
                        ...
                        <a href="<?php echo e(url('carowner/payment-summary')); ?>" class="btn btn-primary">2. PAYMENT SUMMARY</a>
                        <a href="<?php echo e(url('carowner/view-rented-car')); ?>" class="btn btn-primary">3. VIEW RENTED CAR</a>
                        ...
                        <a href="<?php echo e(url('carowner/car-approval-denied')); ?>" class="btn btn-primary">5. CAR APPROVAL DENIED</a>
                        <a href="<?php echo e(url('carowner/approved-car')); ?>" class="btn btn-primary">6. APPROVED CAR</a>
                    </div>
                </div>
            </div>
        </div>
